...
def process_PAM(split_no = 1, device = None, base_path = None, gethalf = False):
...
def process_ECG(split_no = 1, device = None, base_path = None):
...
def process_Boiler(split_no = 1, device = None, base_path = None, normalize = False):
...
def process_Boiler_OLD(split_no = 1, device = None, base_path = None):
